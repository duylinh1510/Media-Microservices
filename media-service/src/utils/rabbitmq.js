...
async function publishEvent(routingKey, message) {
    ...
    // gửi thư có routingKey vào hòm EXCHANGE_NAME
    // do RabbitMQ không hiểu mã Object của Javascript nên cần phải chuyển
    // vào Buffer để biến thành mã nhị phân để RabbitMQ hiểu
